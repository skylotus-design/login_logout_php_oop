<?php
    class Pengguna extends Database {
        ...
        {
            $sql = $this->conn->prepare("SELECT id_pengguna, alamat_email, Kata_sandi FROM pengguna_oop WHERE alamat_email = ? AND kata_sandi = ? LIMIT 1"); //potensi error-> nama kolom tdk dipangil
